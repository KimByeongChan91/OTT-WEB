  ...
  try {
    const response = await axios
      .delete<MemberWishDelResponseType>(
        `https://ott-web-fge9c9ekdjawazgc.koreacentral-01.azurewebsites.net/wishlist/member/delete?email=${memberWishDelData.email}&movieID=${memberWishDelData.movieID}`,
        {
          headers: {
